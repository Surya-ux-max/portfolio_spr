...
export const GridScan = ({
  ...
  }, [sensitivity, lineThickness, linesColor, scanColor, scanOpacity, gridScale, enablePost, bloomIntensity, chromaticAberration, noiseIntensity, smoothTime, maxSpeed, skewScale]);
